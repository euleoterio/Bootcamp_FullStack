...
export default class App extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({
      // allCountries: allCountries, -- faz a mesma coisa que a linha debaixo
      allCountries,
      filteredCountries: Object.assign([], allCountries), //faz uma copia do objeto allCountrie para apontar em lugar diferente na memória
      filteredPopulation,
    });
  }
